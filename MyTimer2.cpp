...
MyTimer2::MyTimer2(string src,string des,int max_time,int Is_Encryption,int Is_Pack,int Is_Compress,string password){
    this->_src=src;
    this->_des=des;
    ...
    QObject::connect(_timer,SIGNAL(timeout()),this,SLOT(MyTimerEvent()));

}

void MyTimer2::MyTimerEvent(){
